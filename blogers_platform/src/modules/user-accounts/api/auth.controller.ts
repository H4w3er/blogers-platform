...
export class AuthController {
    ...
    async login(
        ...
        const accessRefreshToken = await this.commandBus.execute(new LoginUserCommand(user, dto));
    ...
    async refreshToken(
        ...
        const tokens = await this.commandBus.execute(new NewRefreshTokenCommand(dto.refreshToken));
    ...
    async logout(
        ...
        return this.commandBus.execute(new LogoutUserCommand(dto, user));
    }
}
